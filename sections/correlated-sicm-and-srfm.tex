...
fibres. In the inside of the first mentioned round cell nearly no actin signal could be detected 
...
fibres (yellow arrowheads). The cell marked with the white arrow, that was ending with a white 
dot, could be just seen half in the confocal/STED images and dot-like actin structures 
predominate. 

Structures that would have been missed by using one single technique alone: 
\textsf{
...
The full extend of the protrusion & YES & \textbf{NO} \\ \hline

...
% Hier kommt jetzt Fig. 3 aus der ACSNano-Publikation. @Patrick: Dafür bräuchten wir dann auch die 
% Rechte + davon hast du glaube ich auch die Original-PDF-Version!? 

\begin{figure}
  \centering
%   \includegraphics[clip,scale=1]{.PDF} % @Patrick hier bitte auch den entsprechenden Filename 
% eintragen
    \caption{

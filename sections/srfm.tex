...
entire sample is excited at the same time, and all fluorophores in the sample
...
ground state and to emit a photon of the same energy as the incoming
...
emission is selected such that it lies outside the detection window of the
microscope (Fig.~\ref{fig:STED-principle}c, right), which de-facto switches
fluorophores that undergo stimulated emission to an ``off''-state.
...
The best resolution (approximately 2\,nm) obtained by STED microscopy has

...
inactivated (``off''-state, grey dots in Fig.~\ref{fig:lm}a). After applying light suitable to switch the fluorophores
(cyan background, Fig.~\ref{fig:lm}b) from the inactivated to
the activated (``on'') state (white dots), the activated molecules are excited
...
practice the resolution is range of 20\,nm \cite{Betzig2006} since the
theoretical resolution cannot be reached due to background, noise and other
factors. A more detailed description of the resolution enhancement by
localisation is provided by \cite{Mortensen2010}.

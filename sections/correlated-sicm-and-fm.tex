...
In contrast to combining SICM with wide-field microscopy techniques, SICM could be also 
combined with near-field optical microscopy techniques (SNOM/NSOM) 
...
topography and t-tubule distribution in cardiomyocytes \cite{Lyon2012} or for investigating 
intracellular contacts by correlating topography with the distribution of connexin-43 (Cx43) 
\cite{Schultz2019}. Furthermore, it has been utilized in studies investigating endocytotic 
pathways \cite{Shevchuk2008} (Fig.~\ref{fig:sicm+scm}c) and in a study revealing an alternative 
closing mechanism for clathrin-coated pits by recording topography simultaneously with
the fluorescence of tagged actin-binding protein and the tagged
clathrin light-chain \cite{Shevchuk2012}. A further study on clathrin-coated
pit formation and maturation revealed the effect of mutations in the Dynamin~2

...
the localisation of {$\beta_{1}$}-adrenoceptors \cite{Wright2018}, {$\beta_{2}$}-adrenoceptors \cite{Nikolaev2010,Lyon2012,Wright2014,Wright2018} 
and {$\beta_{3}$-adrenoceptors \cite{Schobesberger2020} in healthy and impaired cardiomyocytes. After measuring the 

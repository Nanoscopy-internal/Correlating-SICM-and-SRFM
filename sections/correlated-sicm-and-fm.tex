...
\begin{figure}
  ...
  \caption{
    ...
    \textbf{a:} SICM image of a cardiomyocyte surface. The white arrows indicate the positions, 
    where the stimulation of the $\beta_1$-AR was take place.
    \textbf{b:} F\"orster resonance energy transfer (FRET)-YFP/CFP (yellow and cyan fluorescent 
    protein)-ratio after $\beta_1$-AR stimulation in the crest of the cell (a). 
    \textbf{c:} FRET-YFP/CFP-ratio after $\beta_1$-AR stimulation in the T-tubule of the cell (a).
    \textbf{d:} SICM image of a cardiomyocyte surface. The white arrows indicate the positions, 
    where the stimulation of the $\beta_2$-AR was take place. 
    ...
    A decrease in the FRET-YFP/CFP-ratio indicates an increase in cyclic adenosine monophosphate 
    (cAMP).
    % The rights need to be added here.
  }

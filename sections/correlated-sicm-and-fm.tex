...
corresponding data point in the other set. This immediate correlation allows not only for correlating
studies in fixed samples (figure \ref{fig:sicm+scm}c), but also studies of dynamics in live samples 
(figure \ref{fig:sicm+scm}d).
...
(figure \ref{fig:sicm+scm}d), for the investigating the uptake of fluorescent nanoparticles in 

...
\abstract{%
  ...
  labelled specimen such as proteins and their distribution within a cell at a
...
%
  Investigating the cell membrane is a unique strength of scanning ion conductance
  microscopes (SICM),
  which use a fine tip to determine the topography of the investigated sample
  and thus allows investigating the cell membrane without labelling.
  % 3 times the word "investigating" in this sentence does not look very elegant to me!? 
  % Maybe we can change the senctence to:
  %   The possibility of studying the cell membrane is a unique strength of scanning ion 
  %   conductance microscopes (SICM), which use a fine tip to determine the topography 
  %   of the sample and thus allows investigating the cell membrane without labelling.
%  
...
\input{sections/srfm}
\input{sections/correlated-sicm-and-fm}
\input{sections/correlated-sicm-and-srfm}

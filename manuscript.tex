...
\author{Annika Haak, Astrid Gesper and Patrick Happel}
\authorrunning{Haak et al.}
...
%
  The latter, however, is a unique strength of scanning ion conductance
  microscopes (SICM),
  which use a fine tip to determine the topography of the investigated sample
  and thus allow to investigate the cell membrane without labelling.    
%  
